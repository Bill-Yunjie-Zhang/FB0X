new fullpage('#fullpage', {
    ...
    anchors: ['About-Me', 'Team-Player-And-Leader'],
    navigationTooltips: ['About Me', 'Team Player & Leader'],
    css3: true,
    navigation: true,
    ...
    return c.prototype.update = function() {
        ...
        for (var a = 0; a < this.o.length; a++) {
            ...
            for (var b = this.o.length - 1; b > a; b--) {
                ...
                c > 120 || (this.g.beginPath(), this.g.strokeStyle = this.options.particleColor, this.g.globalAlpha = (120 - c) / 120, this.g.lineWidth = 2, this.g.moveTo(this.o[a].x, this.o[a].y), this.g.lineTo(this.o[b].x, this.o[b].y), this.g.stroke())
            }
        }
